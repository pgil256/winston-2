...
- [x] "Winston 2.0" wordmark bottom-left
- [x] Clamp OrbitControls so camera can't go under the floor
- [x] README.md with screenshot, install/run instructions, controls explainer
